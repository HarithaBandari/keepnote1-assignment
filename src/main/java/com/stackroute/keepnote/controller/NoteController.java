...
public class NoteController {
	...
	public String getNoteDetails(ModelMap map) {
		map.addAttribute("list", noteRepository.getAllNotes());
		return "index";
	}
	...
	public String getNoteData(ModelMap map, @RequestParam("noteId") int noteId,
			@RequestParam("noteTitle") String noteTitle, @RequestParam("noteContent") String noteContent,
	...
	public String delete(@RequestParam("noteId") int noteId) {
		// map.addAttribute("list", object.getAllNotes());
